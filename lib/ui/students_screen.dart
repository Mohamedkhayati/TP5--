    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Dismissible(
            key: Key((students[index].nom ?? '') + index.toString()),
            ...
            child: ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  showDialog(context: context, builder: (BuildContext context) => dialog.buildAlert(context, students[index], false));
                },
              ),
            ),
          );
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          showDialog(context: context, builder: (BuildContext context) => dialog.buildAlert(context, ListEtudiants(0, scolList.codClass, '', '', ''), true));
        },
